...
INSERT INTO `questions` (`id`, `created_at`, `updated_at`, `deleted_at`, `question`, `img`, `answer`, `quiz_id`, `dura`) VALUES
(1, '2024-02-19 16:31:37.346', '2024-02-19 16:31:37.346', NULL, 'Yang merupakan sumber protein kecuali', NULL, 'B', 1, 1),
(2, '2024-02-19 16:34:55.344', '2024-02-19 16:34:55.344', NULL, 'Yang merupakan sumber protein hewani, kecuali...', NULL, 'A', 1, 1),
(3, '2024-02-19 16:39:09.285', '2024-02-19 16:39:09.285', NULL, 'Yang merupakan sumber vitamin A', NULL, 'A', 1, 1);
...
--
ALTER TABLE `quizzes`
  ADD CONSTRAINT `fk_users_quiz` FOREIGN KEY (`user_id`) REFERENCES `users` (`id`);
